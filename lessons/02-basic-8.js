...
PTC.addUnit({
  title: "The Basic 8",
  summary: "The eight-step tango basic and a comfortable follower’s cross.",
  lessons: [
    {
      title: "Lesson 4 · Basic 8",
      date: "2026-09-23",
      duration: "2:12",
      youtube: "NYjfemBEo2o",
      notes: [
        "The Basic 8 is an essential tango sequence worth practicing carefully.",
        "The first three steps and final three steps share movements with the box step.",
        "At the follower’s cross, aim for a pinky-toe-to-pinky-toe foot position."
      ],
      sections: [
        {
        ...
        {
          title: "Creating a Comfortable Cross",
          points: [
            {
      ...
      practice: [
        "Practice the follower’s cross with the left foot over the right, aiming for a pinky-toe-to-pinky-toe position.",
        "Practice the leader and follower steps of the Basic 8 slowly while counting all eight steps.",
        "Practice repeating the basic 8 with a partner.",
        "Repeat steps three, four, and five, focusing on a full follower back step and a complete leader collection before the cross.",
        "Alternate between doing the basic 8 and doing the box."
      ],
      materials: []
    }
  ]
